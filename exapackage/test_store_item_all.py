...
class ShopeeItemAll:
    ...
    def store_all_search(self, store_url_link, sort_by_val):
        ...
        sort_by_key = self.search_sort_by(sort_by_val)
        limit_item_page = 60
        ...
        limit_item_page = 60
        page_count = int(math.ceil(json_data['total_count']/limit_item_page))

        return page_count, json_data

def process_json(self, json_data, max_page):
